## HN.py
## a combination of:
## 1) process_highway_coding.sas,
## 2) coding_overlap.sas,
## 3) import_highway_projects_2.sas
...
class HighwayNetwork:
    ...
    def __init__(self):
        ...
        years_list_raw = pd.read_csv(years_csv_path)[
            "year"
        ].to_list()  # list of years to build
    ...
    def check_hwyproj_coding_table(self):
        ...
        base_project_table_errors = os.path.join(
            mhn_out_folder, "base_project_table_errors.txt"
        )
